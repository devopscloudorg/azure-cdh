...
export affinityGroupName=myeastcdhag
...
export storageAccount=mycdhstorage
...
export imageName=b39f27a8b8c64d52b05eac6a62ebad85__Ubuntu-12_04_4-LTS-amd64-server-20140227-en-us-30GB

#Size of the Virtual machine. Valid sizes are extrasmall, small, medium, large, extralarge, a5, a6, a7
#we do recommend extra large for the management node
export instanceSize=extralarge
...
export vmNamePrefix=yourcdhnode
export cloudServicePrefix=yourcdhsvc
...
export nodeImageName=ubuntucdh5
